...
INSERT INTO users (name_user, role_name, email, password)
VALUES
    ('Иванов Иван Иванович', 'Администратор', 'ivan@mail.ru', 'password'),
    ('Алексеев Алексей Алексеевич', 'Преподаватель', 'alexey@mail.ru', 'pass'),
    ('Марков Марк Маркович', 'Администратор', 'mark@mail.ru', 'securepassword'),
    ('Сидоров Виктор Викторович', 'Преподаватель', 'viktor@mail.ru', 'strongpass'),
    ('Михайлов Михаил Михайлович', 'Вольнослушатель', 'michael@mail.ru', 'spass'),
    ('Дмитриев Дмитрий Дмитриевич', 'Вольнослушатель', 'dmitry@mail.ru', 'gpass'),
    ('Петров Петр Петрович', 'Студент', 'petr@mail.ru', 'mypassword'),
    ('Аверин Иван Петрович', 'Студент', 'aip@mail.ru', 'password100'),
    ('Петров Максим Алексеевич', 'Студент', 'pma@mail.ru', 'my00pass'),
    ('Кириллова Мария Петровна', 'Студент', 'maria@mail.ru', 'my_password'),
    ('Мухина Елена Ивановна', 'Студент', 'mei@mail.ru', 'pass0101');
